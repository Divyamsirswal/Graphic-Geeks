    ...
    <motion.div className="w-full h-screen bg-black overflow-auto">
      ...
      >
        <motion.h1
          ...
          className="text-white text-5xl md:text-7xl sm:text-sm lg:text-7xl font-pixel text-center"
        >
          Content Creation
        </motion.h1>
        <div className="w-full h-max flex items-center justify-center">
          <div className="w-max max-w-7xl grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-1 p-5  m-10">
